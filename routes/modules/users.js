const express = require('express') // 載入 express框架
const router = express.Router() // use express router
const passport = require('passport') // 載入 passport套件
const bcrypt = require('bcryptjs') // 載入 bcryptjs套件
